...
public class CrossRateCalculatorTest {
    ...
    public void tesCrossWithoutCrossCcy() {
        ...
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("GBP", "CHF"), null, true, bd("2.1702"), bd("2.1707"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("EUR", "AED"), null, true, bd("0.7374"), bd("0.7379"));
    ...
    public void tesCrossWithCrossInTarget() {
        LOG.debug("badCross --------------------------------");
        final CurrencyPair tgt = new CurrencyPair("EUR", "CHF");
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("EUR", "JPY"), null, true, bd("2.1702"), bd("2.1707"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("EUR", "AED"), null, true, bd("0.7374"), bd("0.7379"));
        CrossRateCalculator.calculateCross(tgt, fx1, fx2, 4, 4, StandardMajorCurrencyRanking.getDefault(), BigDecimal.ROUND_HALF_UP,
                BigDecimal.ROUND_HALF_UP);
    }
    ...
    public void crossWithNonUsdCross2() {
        ...
        final CurrencyPair tgt = new CurrencyPair("EUR", "CHF");
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("GBP", "CHF"), null, true, bd("2.1702"), bd("2.1707"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("EUR", "GBP"), null, true, bd("0.7374"), bd("0.7379"));
    ...
    public void crossWithNonUsdCross() {
        ...
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("GBP", "CHF"), null, true, bd("2.1702"), bd("2.1707"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("GBP", "JPY"), null, true, bd("192.70"), bd("193"));
        FxRate fxRate = CrossRateCalculator.calculateCross(tgt, fx1, fx2, 4, 4, StandardMajorCurrencyRanking.getDefault(), BigDecimal.ROUND_HALF_UP,
                BigDecimal.ROUND_HALF_UP);
        assertThat(fxRate.getCurrencyPair()).isEqualTo(tgt);
    ...
    public void crossWithMixedUsd() {
        ...
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("EUR", "USD"), null, true, bd("1.2166"), bd("1.2171"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("USD", "SGD"), null, true, bd("1.6782"), bd("1.6792"));
        FxRate fxRate = CrossRateCalculator.calculateCross(tgt, fx1, fx2, 4, 4, StandardMajorCurrencyRanking.getDefault(), BigDecimal.ROUND_HALF_UP,
                BigDecimal.ROUND_HALF_UP);
        assertThat(fxRate.getCurrencyPair()).isEqualTo(tgt);
    ...
    public void crossWithUsdMinor() {
        ...
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("EUR", "USD"), null, true, bd("1.2166"), bd("1.2171"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("AUD", "USD"), null, true, bd("0.6834"), bd("0.6839"));
        FxRate fxRate = CrossRateCalculator.calculateCross(tgt, fx1, fx2, 4, 4, StandardMajorCurrencyRanking.getDefault(), BigDecimal.ROUND_HALF_UP,
                BigDecimal.ROUND_HALF_UP);
        assertThat(fxRate.getCurrencyPair()).isEqualTo(tgt);
    ...
    public void crossWithUsdMajorInversed() {
        ...
        final FxRateImpl fx1 = new FxRateImpl(new CurrencyPair("USD", "CAD"), null, true, bd("1.4874"), bd("1.4879"));
        final FxRateImpl fx2 = new FxRateImpl(new CurrencyPair("USD", "SGD"), null, true, bd("1.6782"), bd("1.6792"));
        ...
        fxRate = CrossRateCalculator.calculateCross(tgtInverted, fx1.createInverse(), fx2.createInverse(), 4, 4,
                StandardMajorCurrencyRanking.getDefault(), BigDecimal.ROUND_HALF_UP, BigDecimal.ROUND_HALF_UP);
