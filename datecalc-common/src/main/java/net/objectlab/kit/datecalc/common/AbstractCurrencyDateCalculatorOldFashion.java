 ...
 */package net.objectlab.kit.datecalc.common;
  ...
  *
  */
public abstract class AbstractCurrencyDateCalculatorOldFashion<E> {
    ...
    public AbstractCurrencyDateCalculatorOldFashion(final String ccy1, final String ccy2, final DateCalculator<E> calculator,
